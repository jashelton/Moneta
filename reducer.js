...
export const GET_RECENT_ACTIVITY_FOR_USER =
  "moneta/events/GET_RECENT_ACTIVITY_FOR_USER";
export const GET_RECENT_ACTIVITY_FOR_USER_SUCCESS =
  "moneta/events/GET_RECENT_ACTIVITY_FOR_USER_SUCCESS";
export const GET_RECENT_ACTIVITY_FOR_USER_FAIL =
  "moneta/events/GET_RECENT_ACTIVITY_FOR_USER_FAIL";
export const LOAD_MORE_ROWS_FOR_USER_ACTIVITY =
  "moneta/events/LOAD_MORE_ROWS_FOR_USER_ACTIVITY";
export const LOAD_MORE_ROWS_FOR_USER_ACTIVITY_SUCCESS =
  "moneta/events/LOAD_MORE_ROWS_FOR_USER_ACTIVITY_SUCCESS";
export const LOAD_MORE_ROWS_FOR_USER_ACTIVITY_FAIL =
  "moneta/events/LOAD_MORE_ROWS_FOR_USER_ACTIVITY_FAIL";
...
export const UPDATE_EVENT_LIKES_SUCCESS =
  "moneta/eventDetails/UPDATE_LIKES_SUCCESS";
export const UPDATE_EVENT_LIKES_FAIL = "moneta/eventDetails/UPDATE_LIKES_FAIL";
export const UPDATE_EVENT_LIKES_ACTIVITY =
  "moneta/eventDetails/UPDATE_LIKES_ACTIVITY";
export const UPDATE_EVENT_LIKES_ACTIVITY_SUCCESS =
  "moneta/eventDetails/UPDATE_LIKES_ACTIVITY_SUCCESS";
export const UPDATE_EVENT_LIKES_ACTIVITY_FAIL =
  "moneta/eventDetails/UPDATE_LIKES_ACTIVITY_FAIL";
...
export const MARK_EVENT_VIEWED_SUCCESS =
  "monesta/markers/MARK_EVENT_VIEWED_SUCCESS";
...
export const UPDATE_EVENT_RATING_SUCCESS =
  "moneta/events/UPDATE_EVENT_RATING_SUCCESS";
export const UPDATE_EVENT_RATING_FAIL =
  "moneta/events/UPDATE_EVENT_RATING_FAIL";
export const UPDATE_EVENT_DETAILS_RATING =
  "moneta/events/UPDATE_EVENT_DETAILS_RATING";
export const UPDATE_EVENT_DETAILS_RATING_SUCCESS =
  "moneta/events/UPDATE_EVENT_DETAILS_RATING_SUCCESS";
export const UPDATE_EVENT_DETAILS_RATING_FAIL =
  "moneta/events/UPDATE_EVENT_DETAILS_RATING_FAIL";
export const GET_LIKES_FOR_EVENT = "moneta/events/GET_LIKES_FOR_EVENT";
export const GET_LIKES_FOR_EVENT_SUCCESS =
  "moneta/events/GET_LIKES_FOR_EVENT_SUCCESS";
export const GET_LIKES_FOR_EVENT_FAIL =
  "moneta/events/GET_LIKES_FOR_EVENT_FAIL";
...
export const GET_USER_DETAILS_SUCCESS =
  "moneta/users/LOAD_USER_DETAILS_SUCCESS";
...
export const GET_CURRENT_USER_DETAILS =
  "moneta/users/LOAD_CURRENT_USER_DETAILS";
export const GET_CURRENT_USER_DETAILS_SUCCESS =
  "moneta/users/LOAD_CURRENT_USER_DETAILS_SUCCESS";
export const GET_CURRENT_USER_DETAILS_FAIL =
  "moneta/users/LOAD_CURRENT_USER_DETAILS_FAIL";
export const UPDATE_CURRENT_USER = "moneta/users/UPDATE_CURRENT_USER";
export const UPDATE_CURRENT_USER_SUCCESS =
  "moneta/users/UPDATE_CURRENT_USER_SUCCESS";
...
export const UPDATE_USER_FOLLOWS_SUCCESS =
  "moneta/users/UPDATE_USER_FOLLOWS_SUCCESS";
export const UPDATE_USER_FOLLOWS_FAIL = "moneta/users/UPDATE_USER_FOLLOWS_FAIL";
export const GET_RECENT_ACTIVITY_FOR_CURRENT_USER =
  "moneta/users/GET_RECENT_ACTIVITY_FOR_CURRENT_USER";
export const GET_RECENT_ACTIVITY_FOR_CURRENT_USER_SUCCESS =
  "moneta/users/GET_RECENT_ACTIVITY_FOR_CURRENT_USER_SUCCESS";
export const GET_RECENT_ACTIVITY_FOR_CURRENT_USER_FAIL =
  "moneta/users/GET_RECENT_ACTIVITY_FOR_CURRENT_USER_FAIL";
export const GET_CURRENT_USER_STATS = "moneta/users/GET_CURRENT_USER_STATS";
export const GET_CURRENT_USER_STATS_SUCCESS =
  "moneta/users/GET_CURRENT_USER_STATS_SUCCESS";
export const GET_CURRENT_USER_STATS_FAIL =
  "moneta/users/GET_CURRENT_USER_STATS_FAIL";
export const LOAD_MORE_ROWS_FOR_CURRENT_USER_ACTIVITY =
  "moneta/events/LOAD_MORE_ROWS_FOR_CURRENT_USER_ACTIVITY";
export const LOAD_MORE_ROWS_FOR_CURRENT_USER_ACTIVITY_SUCCESS =
  "moneta/events/LOAD_MORE_ROWS_FOR_CURRENT_USER_ACTIVITY_SUCCESS";
export const LOAD_MORE_ROWS_FOR_CURRENT_USER_ACTIVITY_FAIL =
  "moneta/events/LOAD_MORE_ROWS_FOR_CURRENT_USER_ACTIVITY_FAIL";

export const CREATE_ERROR = "moneta/errors/CREATE_ERROR";
  ...
  switch (action.type) {
    ...
    case GET_RECENT_ACTIVITY_SUCCESS:
      return {
        ...state,
        loading: false,
        recentEvents: action.payload.data.events
      };
    ...
    case LOAD_MORE_ROWS_FOR_USER_ACTIVITY_SUCCESS:
      if (action.payload.data.length) {
        const updatedUserActivity = update(state.userActivity, {
    ...
    case LOAD_MORE_ROWS_SUCCESS:
      const updatedEvents = update(state.recentEvents, {
        $push: action.payload.data.events
      });
    ...
    case UPDATE_EVENT_LIKES_SUCCESS:
      ...
      const updatedEvent = update(state.event, {
        $set: { ...state.event, liked, likes_count }
      });
    ...
    case UPDATE_EVENT_LIKES_ACTIVITY_SUCCESS:
      ...
      const eventIndex = state.recentEvents.findIndex(
        ei => ei.id === parseInt(activityEventId)
      );
      const updatedLikeInRecent = update(state.recentEvents, {
        [eventIndex]: {
          liked: { $set: activityLiked },
          likes_count: { $set: activityLikesCount }
        }
      });
    ...
    case MARK_EVENT_VIEWED_SUCCESS:
      ...
      if (state.markers.length) {
        ...
        const updatedMarkers = update(state.markers, {
          [index]: { viewed_id: { $set: insertId } }
        });
    ...
    case CREATE_EVENT_SUCCESS:
      const updatedEventsCreate = update(state.recentEvents, {
        $unshift: action.payload.data.event
      });
      const updatedMarkersCreate = update(state.markers, {
        $push: action.payload.data.marker
      });
      return {
        ...state,
        loading: false,
        recentEvents: updatedEventsCreate,
        markers: updatedMarkersCreate
      };
    ...
    case CREATE_COMMENT_SUCCESS:
      const updatedEventDetails = update(state.event, {
    ...
    case UPDATE_EVENT_RATING_SUCCESS:
      ...
      const eventIndexForRating = state.recentEvents.findIndex(
        e => e.id === parseInt(updatedRatingInfo.event_id)
      );
    ...
    case UPDATE_CURRENT_USER_SUCCESS:
      const updatedUser = update(state.currentUserDetails, {
    ...
    case UPDATE_USER_FOLLOWS_SUCCESS:
      ...
      const updatedInfo = update(userDetails, {
        $set: { ...userDetails, ...action.payload.data }
      });
    ...
    case GET_RECENT_ACTIVITY_FOR_CURRENT_USER_SUCCESS:
      return {
        ...state,
        loading: false,
        currentUserActivity: action.payload.data
      };
    ...
    case GET_CURRENT_USER_STATS_SUCCESS:
      return {
        ...state,
        loading: false,
        currentUserStats: action.payload.data
      };
    ...
    case LOAD_MORE_ROWS_FOR_CURRENT_USER_ACTIVITY_SUCCESS:
      if (action.payload.data.length) {
        const updatedCurrentUserActivity = update(state.currentUserActivity, {
          $push: action.payload.data
        });
        return {
          ...state,
          loading: false,
          currentUserActivity: updatedCurrentUserActivity
        };
      } else {
        return { ...state, loading: false };
      }
...
export function updateEventDetailsLikes(eventId, eventLiked, from) {
  ...
  const type =
    from === "details" ? UPDATE_EVENT_LIKES : UPDATE_EVENT_LIKES_ACTIVITY;
